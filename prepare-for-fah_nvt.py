...
solvated_pdb_filename = '%s_nvt/solvated.pdb' % model_index

minimized_pdb_filename = '%s_nvt/minimized.pdb' % model_index
equilibrated_pdb_filename = '%s_nvt/equilibrated.pdb' % model_index

system_xml_filename = '%s_nvt/system.xml' % model_index
integrator_xml_filename = '%s_nvt/integrator.xml' % model_index
state_xml_filename = '%s_nvt/state.xml' % model_index
